...
def _parse_tb3_lab_state(state_json, num_robots=None, robot_obs_dim=8):
    """Parse TurtleBot3 lab state.json into an 8D per-robot observation tensor.

    Encoding: [x, y, cos(yaw), sin(yaw), v_lin, v_ang, dist_to_goal, min_neighbor_dist]
    """
...
class SequenceWebDataset(IterableDataset):
    ...
    def __iter__(self):
        ...
        for sample in dataset:
            ...
            elif self.dataset_type == "tb3_lab":
