...
Saves results as a summary CSV in the outputs/plots/comparison folder.
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Compute metrics from MC dropout CSVs and save to outputs/plots/comparison."
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default="outputs/plots/comparison",
